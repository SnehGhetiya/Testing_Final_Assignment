...
namespace UnitTest
{
    public class PassengerUnitTest
    {
        ...
        private static List<PassengerView> GetPassenger()
        {
            ...
            {
                new PassengerView() {P_No=1,F_Name="Kishan",L_Name="Dasani",Phone=798086533},
                new PassengerView() {P_No=1,F_Name="Akshayrajsinh",L_Name="Jadeja",Phone=798086533},
                new PassengerView() {P_No=1,F_Name="Raj",L_Name="Parmar",Phone=798086533},
        ...
        public void GetPassengerById1()
        {
            ...
            passenger.P_No = 1;
            passenger.F_Name = "Mukesh";
            passenger.L_Name = "Shah";
        ...
        public void AddPassenger1()
        {
            ...
            newPassenger.P_No = 4;
            newPassenger.F_Name = "Sneh";
            newPassenger.L_Name = "Ghetiya";
        ...
        public void UpdatePassenger1()
        {
            ...
            UpdatePassenger.F_Name = "Hem";
            UpdatePassenger.L_Name = "Bhagat";
